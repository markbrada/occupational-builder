...
### v0.7.9
- Locked manual dimension drag snapping to grid intersections for both endpoints.

### v0.7.8
- Updated manual dimension handle snapping to align endpoints with object/point snapping.

### v0.7.7
- Improved manual dimension handle snapping to respect object/grid snapping rules.

### v0.7.6
- Refined manual dimension handle placement and snapping behavior.
